...
export default function App() {
    ...
    <div className="absolute top-12 right-0 w-64 bg-black/90 backdrop-blur-3xl border border-white/10 rounded-2xl p-2 shadow-[0_20px_50px_rgba(0,0,0,0.8)] flex flex-col gap-1 z-50 max-h-[80dvh] overflow-y-auto custom-scrollbar text-left">
      ...
      {mode === 'camera' && (
        <>
          ...
          {!isFullscreen && showUnifiedIPadLayout && (
            <button 
      ...
      {mode === 'receiver' && (
        <>
          ...
          {(!isNativeApp || showUnifiedIPadLayout) && (
            <button 
  ...
  const iosCustomStyles = `
    ...
    @supports (-webkit-touch-callout: none) {
      ...
      @media (orientation: portrait) and (min-width: 768px) {
        ...
        .ipad-unified-layout .home-logo-text {
          font-size: 2.5rem !important; 
          line-height: 1.2 !important;
          margin-top: 2rem !important; 
          margin-bottom: 0 !important;
        }
        .ipad-unified-layout .home-tile-container {
          max-width: 70% !important; 
          width: 100% !important;
          gap: 4.5rem !important; 
          margin-top: -5vh !important; 
        }
        .ipad-unified-layout .home-tile {
          width: 100% !important;
        ...
        .ipad-unified-layout .home-tile .icon-wrapper {
          width: 4.5rem !important; 
          height: 4.5rem !important;
          margin-bottom: 1rem !important; 
          border-radius: 1.2rem !important;
        }
        .ipad-unified-layout .home-tile .icon-wrapper svg {
          width: 2.2rem !important;
          height: 2.2rem !important;
        }
        .ipad-unified-layout .home-tile h3 {
          font-size: 1.5rem !important;
        }
      }

      @media (orientation: landscape) {
        .ipad-unified-layout .landscape-disconnected-container {
           width: 100% !important;
  ...
  // --- HARDWARE LAYOUT ROUTER ---
  if (!showUnifiedIPadLayout) {
    // ============================================================================
    // BRANCH 1: THE V2.0 GOLDEN MASTER (ANDROID / IPHONE / WEB)
    // ============================================================================
    return (
      <div className={
  ...
  // ============================================================================
  // BRANCH 2: THE IPAD UNIFIED LAYOUT
  // ============================================================================
  return (
    <div className={
      `h-[100dvh] w-full bg-[#0a0510] text-white font-sans antialiased p-3 md:p-6 flex flex-col items-center justify-start overflow-hidden selection:bg-pink-500/30 relative ipad-unified-layout`
    }>
